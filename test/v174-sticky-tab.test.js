// v1.6.74: tab sticky + 更明顯的 active 視覺
...
test('v1.6.74: wn-tabs sticky 定位', () => {
...
test('v1.6.74: tab 字體更大 (1.05em + 12px padding)', () => {
...
test('v1.6.74: tab active 放大 1.25 + 箭頭', () => {
...
test('v1.6.74: tab active 有向下箭頭 ::after', () => {
