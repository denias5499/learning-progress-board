// v1.6.83: mousedown 立即新增 crop box (最簡單邏輯)
...
test('v1.6.83: mousedown handler 立即新增 box', () => {
...
test('v1.6.83: 不再有 mouseup click 邏輯 (移除複雜的 isClick 判斷)', () => {
...
test('v1.6.83: mousedown 與 mouseup 各自獨立 (mousedown 新增, mouseup drag)', () => {
