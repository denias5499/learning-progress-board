// v1.6.83 Phase 1: 錯題資料庫獨立 page 架構
...
test('v1.6.83: top-level nav 按鈕 「📚 錯題資料庫」 存在', () => {
...
test('v1.6.83: page-wrongnotes page 存在 (top-level)', () => {
    assert.ok(/<div id="page-wrongnotes"[^>]*class="page-view"/.test(html),
        'page-wrongnotes 應是 page-view');
});

test('v1.6.83: 4 個 nav pages 存在 (import/notes/stats/practice)', () => {
...
test('v1.6.83: 4 個 tab 按鈕 綁定 switchWrongNotesView', () => {
...
test('v1.6.83: openWrongNotes 函式存在 + 第一次提示用戶建立資料夾', () => {
...
test('v1.6.83: switchWrongNotesView 切換 nav pages', () => {
...
test('v1.6.83: showPage 處理 page-wrongnotes', () => {
...
test('v1.6.83: CSS 樣式存在 (wn-tab, wn-page)', () => {
