...
test('v1.6.72: tab active CSS 放大立體紫色', () => {
    ...
    assert.ok(/background:\s*#b78fb7/.test(css), '應有紫色背景');
});

test('v1.6.72: crop drawing mousedown/mousemove/mouseup 實作', () => {
...
test('v1.6.72: crop drawing 限制 10 個', () => {
...
test('v1.6.72: drag & drop 用 addEventListener', () => {
...
test('v1.6.72: title 更新為 [v1.6.72]', () => {
