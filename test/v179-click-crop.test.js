// v1.6.83: mousedown 直接新增 crop box (簡化邏輯, 取代 v1.6.83 isClick 判斷)
...
test('v1.6.83: mousedown 立即新增 150x150 crop box', () => {
...
test('v1.6.83: mouseup 變 no-op (v1.6.83 簡化)', () => {
